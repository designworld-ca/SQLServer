--checks for CIS Control 5.5 Log Failed Administrative Login Attempts and Control 6.3 enable detailed logging
--as there are multiple ways to implement auditing check for the existence of them
--with these queries

--see if any audits have been created and if they write to windows event log
